...
export const FAQ: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col px-5 pt-4 pb-24 animate-fade-in">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">{t.helpFaq}</h1>
      ...
      <div className="mb-6">
        <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">{t.commonQ}</h3>
      ...
      <div className="mt-4 rounded-2xl bg-gradient-to-br from-primary/10 to-blue-200/20 dark:from-primary/20 dark:to-slate-800 p-6 text-center">
        ...
        <h4 className="text-base font-bold text-gray-900 dark:text-white">{t.stillQuestions}</h4>
        <p className="mt-1 mb-4 text-sm text-gray-500 dark:text-gray-400">{t.teamHelp}</p>
